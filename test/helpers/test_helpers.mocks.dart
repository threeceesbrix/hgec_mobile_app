...
// in hgec_mobile_app/test/helpers/test_helpers.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSqliteService extends _i1.Mock implements _i10.SqliteService {
  @override
  _i6.Future<_i2.Database> get db => (super.noSuchMethod(
        ...
        returnValueForMissingStub:
            _i6.Future<_i2.Database>.value(_FakeDatabase_0(
          this,
          Invocation.getter(#db),
        )),
  ...
  @override
  _i6.Future<void> createDatabase(
    _i2.Database? db,
    int? version,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i6.Future<void> upgradeDatabase(
    _i2.Database? db,
    int? oldVersion,
    int? newVersion,
  ) =>
  ...
  @override
  _i6.Future<String> loadSqlFile(String? fileName) => (super.noSuchMethod(
        Invocation.method(
          #loadSqlFile,
          [fileName],
        ),
  ...
  @override
  _i6.Future<bool> deleteUserInfo(int? id) => (super.noSuchMethod(
        Invocation.method(
          #deleteUserInfo,
          [id],
        ),
  ...
  @override
  _i6.Future<_i11.SqlUserInfo?> getUserInfo(int? id) => (super.noSuchMethod(
        Invocation.method(
          #getUserInfo,
          [id],
        ),
  ...
  @override
  _i6.Future<bool> insertUserInfo(_i11.SqlUserInfo? userInfo) =>
      (super.noSuchMethod(
        Invocation.method(
          #insertUserInfo,
          [userInfo],
...
class MockHomeService extends _i1.Mock implements _i12.HomeService {
  @override
  _i6.Future<_i11.SqlUserInfo?> getUserInfo() => (super.noSuchMethod(
        Invocation.method(
          #getUserInfo,
          [],
        ),
